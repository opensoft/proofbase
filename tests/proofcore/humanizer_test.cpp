...
INSTANTIATE_TEST_CASE_P(
    HumanizeTimeTestParameters, HumanizerTimeTest,
    testing::Values(
        ...
        tuple<QString, qlonglong, Proof::Humanizer::TimeCategory>("1w", 60 * 60 * 24 * 10,
                                                                  Proof::Humanizer::StopAtWeeks)));
...
INSTANTIATE_TEST_CASE_P(
    HumanizeBytesSizeTestParameters, HumanizerBytesSizeTest,
    testing::Values(tuple<QString, qlonglong>("0 bytes", 0ll), tuple<QString, qlonglong>("1 bytes", 1ll),
                    tuple<QString, qlonglong>("512 bytes", 512ll), tuple<QString, qlonglong>("1000 bytes", 1000ll),
                    tuple<QString, qlonglong>("1.00K", 1024ll), tuple<QString, qlonglong>("1.00K", 1025ll),
                    tuple<QString, qlonglong>("2.00K", 2048ll), tuple<QString, qlonglong>("976.56K", 1000000ll),
                    tuple<QString, qlonglong>("1.00M", 1048576ll), tuple<QString, qlonglong>("1.00M", 1048577ll),
                    tuple<QString, qlonglong>("2.00M", 2097152ll), tuple<QString, qlonglong>("953.67M", 1000000000ll),
                    tuple<QString, qlonglong>("1.00G", 1073741824ll), tuple<QString, qlonglong>("1.00G", 1073741825ll),
